...
/**
 * Response is responsible for managing the response text, status and headers of an HTTP response.
 *
...
class Response
{
     ...
     * @var array
     */
    protected array $_statusCodes = array(
        100 => 'Continue',
     ...
     * @var File
     */
    protected ?Service\File $_file = null;
    ...
    protected function _setContentLength(): void
    {
        ...
        if ($shouldSetLength && !$this->outputCompressed()) {
            ...
            if (ini_get('mbstring.func_overload') & 2 && function_exists('mb_strlen')) {
                ...
                $this->length($this->_headers['Content-Length'] = $offset + mb_strlen((string)$this->_body));
            }
        }
    }
     ...
     * @return void
     */
    protected function _sendContent($content): void
    {
        echo $content;
    }
     ...
     * @param array|string|null $value The header value(s)
     * @return array list of headers to be sent
     */
    public function header(array|string $header = null, array|string $value = null): array
    {
        if ($header === null) {
     ...
     */
    public function httpCodes(array|int $code = null): array|bool|null
    {
        if (empty($code)) {
     ...
     * @return bool|array|string|null current content type or false if supplied an invalid content type
     */
    public function type(array|string $contentType = null): bool|array|string|null
    {
        if ($contentType === null) {
     ...
     */
    public function getMimeType(string $alias): mixed
    {
     ...
     */
    public function mapType(array|string $ctype): string|array|null
    {
        if (is_array($ctype)) {
     ...
     * @return void
     */
    public function cache(int|string $since, int|string $time = '+1 day'): void
    {
        if (!is_int($time)) {
            $time = strtotime($time);
        }
     ...
     *
     * @param DateTime|string|null $time Valid time string or DateTime object.
     * @return string|null
     */
    public function expires(DateTime|string $time = null): ?string
    {
        if ($time !== null) {
     ...
     * @return string|null
     */
    public function modified(DateTime|string $time = null): ?string
    {
        if ($time !== null) {
            $date = $this->_getUTCDate($time);
     ...
     * @return array|null
     */
    public function vary(array|string $cacheVariances = null): ?array
    {
     ...
     * can be cached by an HTTP client. A bad way of generating Etags is
     ...
     * as timezone
     *
     * @param DateTime|int|string|null $time Valid time string or unix timestamp or DateTime object.
     * @return DateTime
     * @throws Exception
     */
    protected function _getUTCDate(DateTime|int|string $time = null): DateTime
    {
     ...
     */
    public function protocol($protocol = null): string
    {
        if ($protocol !== null) {
     ...
     * @return int|null
     */
    public function length(int $bytes = null): ?int
    {
        if ($bytes !== null) {
     ...
     * @throws Exception
     */
    public function checkNotModified(Request $request): bool
    {
     ...
     * @return mixed
     */
    public function cookie(array|string $options = null): mixed
    {
        if ($options === null) {
     ...
     *
     * This method allow multiple ways to set up the domains, see the examples
     *
     * ### Full URI
     ...
     * @return void
     */
    public function cors(Request $request, array|string $allowedDomains, array|string $allowedMethods = array(), array|string $allowedHeaders = array()): void
    {
     ...
     * @param bool $requestIsSSL Whether it's an SSL request.
     * @return array
     */
     ...
     */
    public function file(string $path, array $options = array()): void
    {
        $options += array(
            'name' => null,
            'download' => null
        ...
        if (!$file->exists() || !$file->readable()) {
            //if (Configure::read('debug')) { // TODO!! Configure::read('debug') заменить
            //    throw new NotFoundException("The requested file $path was not found or not readable");
            //}
     ...
     * @return void
     */
    protected function _fileRange(Service\File $file, string $httpRange): void
    {
        $fileSize = $file->size();
        $lastByte = $fileSize - 1;
        $start = 0;
     ...
     */
    protected function _sendFile(Service\File $file, array $range): bool
    {
