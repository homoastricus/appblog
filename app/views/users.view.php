...
<ul>
    <?php foreach ($users as $user) : ?>
        <li class="<?php echo theme('text-white-75', 'text-dark') ?>"><?php echo $user->name; ?> - <a href="/user/<?php echo $user->user_id ?>" class="<?php echo theme('text-light', 'text-primary') ?>">U</a> - <a href="/user/delete/<?php echo $user->user_id ?>?page=<?php echo $page; ?>" class="<?php echo theme('text-light', 'text-primary') ?>">X</a></li>
    <?php endforeach; ?>
</ul>
