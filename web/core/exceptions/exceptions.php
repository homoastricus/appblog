 ...
 * @var array
 */
	protected ?array $_responseHeaders = null;
 ...
 * @see Response::header()
 */
	public function responseHeader(array|string $header = null, string $value = null): ?array
    {
		if ($header) {
			if (is_array($header)) {
 ...
 * @package       Cake.Error
 */
class MissingControllerException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingActionException extends AppException {
 ...
 * @package       Cake.Error
 */
class PrivateActionException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingComponentException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingBehaviorException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingLayoutException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingHelperException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingDatabaseException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingConnectionException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingTaskException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingShellMethodException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingShellException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingDatasourceConfigException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingDatasourceException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingTableException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingModelException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingTestLoaderException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingPluginException extends AppException {
 ...
 * @package       Cake.Error
 */
class MissingDispatcherFilterException extends AppException {
 ...
 * @package       Cake.Error
 */
class ConfigureException extends AppException {
}
 ...
 * @package       Cake.Error
 */
class FatalErrorException extends AppException {
