...
class EmailManager
{
     ...
     */
    private function safeFile($filename): string
    {
     ...
     * От кого.
     */
    public function from($email, $name = null): void
    {
     ...
     * Кому.
     */
    public function to($email, $name = null): void
    {
        $this->toEmail = $email;
        $this->toName = $name;
    }
     ...
     * Отправка.
     */
    public function send(): bool|array
    {
